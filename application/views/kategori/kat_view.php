							...
							<div class="box-body">
								<?php if(!empty($this->input->get('id'))){?>
									<form method="post" action="<?= base_url('data/katproses');?>">
										...
										<button type="submit" class="btn btn-custom" style="background-color: #2C3E50; color: white"><i class="fa fa-edit"></i> Edit Kategori</button>
									</form>
								<?php }else{?>
									...
									<form method="post" action="<?= base_url('data/katproses');?>">
										...
										<button type="submit" class="btn btn-custom" style="background-color: #2C3E50; color: white"> <i class="fa fa-plus"></i> Tambah Kategori</button>
									</form>
								<?php }?>
							</div>
						</div>
