							...
							<div class="box-body">
								<?php if(!empty($this->input->get('id'))){?>
									<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
										...
										<button type="submit" class="btn btn-custom" style="background-color: #2C3E50; color: white"> <i class="fa fa-edit"></i> Edit Harga Denda</button>
									</form>
								<?php }else{?>
									...
									<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
										...
										<button type="submit" class="btn btn-custom" style="background-color: #2C3E50; color: white"> <i class="fa fa-plus"></i> Tambah Harga Denda</button>
									</form>
								<?php }?>
							</div>
						</div>
