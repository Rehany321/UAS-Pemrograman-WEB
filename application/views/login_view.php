...
<head>
  ...
  <link rel="icon" href="./assets_style/image/logo.png">
...
'<?php echo base_url('assets_style/image/Buku8.png');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  ...
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #2C3E50;">
    ...
    <form action="<?= base_url('login/auth');?>" method="POST">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          <button type="submit" id="loding" class="btn btn-custom btn-block btn-flat" style="background-color: #2C3E50; color: white">Sign In</button>
