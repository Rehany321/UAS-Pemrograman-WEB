...
<head>
  ...
  <title><?php echo $title_web;?> | Sistem Informasi Perpustakaan Bumigora </title>
...
<body class="hold-transition skin-blue-light sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="<?php echo base_url('index.php/dashboard');?>" class="logo" style="background-color: #2c3e50">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>P</b>B</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg">Perpus Bumigora</span>
      </a>
