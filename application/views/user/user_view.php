...
<div class="content-wrapper">
 ...
 <section class="content">
   ...
   <div class="row">
     <div class="col-md-12">
       <div class="box box-custom" style=" lighting-color: #2C3E50">
        <div class="box-header with-border">
          <a href="user/tambah"><button class="btn active btn-custom, text-light" style="background-color: #2C3E50; border-color: #2C3E50; color: white; "><i class="fa fa-plus"> </i> Tambah User</button></a>
